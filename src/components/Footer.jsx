...
function Footer() {
  return (
    <Banner className="mt-12 bg-red-100 rounded-md my-5  ">
      <div className="flex w-full items-center justify-between border-b border-gray-200  p-4 dark:border-gray-600 dark:bg-gray-700">
        <div className="mx-auto  w-full  items-center sm:w-auto text-center">
          ...
          >
            ...
            <TextInput
              ...
              type="email"
            />
            <Button className='mt-2 bg-pink-500' type="submit">Subscribe</Button>
          </form>
        </div>
